...
public class DijkstraUtilTest {
    ...
    public void testFindSpasWithinDistance() {
        ...
        // Should find Spa 1 (dist 0), and then stop if initial radius matches.
        // Wait, the logic is "if no spas found, increment radius".
        // Spa 1 is at 0km, so it should be found within 5km.
        
        List<DijkstraUtil.Node> results = DijkstraUtil.findSpasWithinDistance(10.0, 10.0, allSpas, 5.0);
